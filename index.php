<?php
  ...
  #ORDER BY id DESC LIMIT 1;
	...
	$ammonia_result = mysqli_query($sqlConnect, "SELECT * FROM `ammonia` ORDER BY `id`  DESC LIMIT 6");
	$ammonia_text = "";
		...
		<div id="app" class="app">
			<div id="header" class="app-header">
				<div class="brand">
					<a href="#" class="brand-logo">
                        <h3>Performance analysis of photovoltaic cells</h3>
					</a>
				</div>
				<div class="menu">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-notification">
							...
							<a href="#" class="dropdown-notification-item">
								...
								<div class="dropdown-notification-info">
									<div class="title">Shading Alert</div>
							...
							<a href="#" class="dropdown-notification-item">
								...
								<div class="dropdown-notification-info">
									<div class="title">Everything is fine</div>
									<div class="time">Absolute </div>
								</div>
								<div class="dropdown-notification-arrow">
									<i class="fa fa-chevron-right"></i>
								</div>
			...
			<div id="content" class="app-content">
				<h1 class="page-header mb-3">
					Hi, Supervisor. <small>here's what's happening today.</small>
				</h1>
				<div class="row">
					<div class="col-xl-6">
						<div class="row">
...
var handleRenderChart = function() {
	...
	chart3 = new Chart(ctx3, {
		type: 'line',
		data: {
			labels: ['Power |  Days', <?php echo implode(", ", $pv_data1['label']); ?>],
				datasets: [{
